...
eva_image = fr.load_image_file("eva.jpg")
eva_face_encoding = fr.face_encodings(eva_image)[0]

known_face_encodings = [eva_face_encoding]
known_face_names = ["Evangeline"]
...
while True:
    ...
    for(top, right, bottom, left), face_encodings in zip(face_location,face_encoding):
        ...
        cv2.putText(frame, name, (left+6, bottom - 6), font, 10.0, (255,255), 1)
